...
const expectWinningLine = [{ rowIndex: 1, collIndex: 4 }, { rowIndex: 2, collIndex: 3 }, { rowIndex: 0, collIndex: 4 }, { rowIndex: 0, collIndex: 3 },{ rowIndex: 0, collIndex: 5 }];
const expectRightPlane = [{ rowIndex: 1, collIndex: 4 }, { rowIndex: 2, collIndex: 3 }];
const expectHorizontalPlane = [{ rowIndex: 0, collIndex: 4 }, { rowIndex: 0, collIndex: 3 }];
