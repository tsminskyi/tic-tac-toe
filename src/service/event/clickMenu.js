...
const clickMenu = (event, props) => {
    ...
    const {
        settingSizeField, settingMode, settingSymbol, playingField,
        mode, playerFirstSymbol, settingTurn, startNewGame, endGame
    } = props;
    ...
    switch (event.target.id) {
        ...
        case 'new_game': {
            ...
            if (playingField != null && mode != null && playerFirstSymbol != null) {
                ...
                const setTurn = playerFirstSymbol === gameSymbols.cross;
                settingTurn(setTurn);
                startNewGame();
